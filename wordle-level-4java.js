document.addEventListener("DOMContentLoaded", function () {
    const wordList = ["reisen","butter","garten","heimat","morgen","teller","wissen",""]; // Wortliste
    const wordLength = 6; // Nur 5-Buchstaben-Wörter
    ...
    const maxAttempts = 7; // Maximale Versuche
    ...
    function makeGuess() {
      ...
      if (guess.length !== wordLength) {
        alert("Ungültiger Versuch. Das Wort muss genau 6 Buchstaben haben.");
        return; 
      }
  
      const newWord = ["_", "_", "_", "_", "_","_"];
      let correct = 0;
