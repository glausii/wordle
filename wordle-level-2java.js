document.addEventListener("DOMContentLoaded", function () {
    const wordList = ["wald","tank","ding","frau","ganz","haut","igel","judo","kuss","lauf","mann","null","pech",
    "quiz","raum","sitz","tisch","ufer","vase","yoga","zelt"];// Wortliste
    const wordLength = 4; // Nur 4-Buchstaben-Wörter
    ...
    function makeGuess() {
      ...
      if (guess.length !== wordLength) {
        alert("Ungültiger Versuch. Das Wort muss genau 4 Buchstaben haben.");
        return; 
      }
  
      const newWord = ["_", "_", "_", "_"];
      let correct = 0;
