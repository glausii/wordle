document.addEventListener("DOMContentLoaded", function () {
    const wordList = ["pflanze"]; // Wortliste
    const wordLength = 7; // Nur 5-Buchstaben-Wörter
    ...
    const maxAttempts = 8; // Maximale Versuche
    ...
    function makeGuess() {
      ...
      if (guess.length !== wordLength) {
        alert("Ungültiger Versuch. Das Wort muss genau 7 Buchstaben haben.");
        return; 
      }
  
      const newWord = ["_", "_", "_", "_", "_", "_", "_"];
      let correct = 0;
