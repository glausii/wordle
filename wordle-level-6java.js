document.addEventListener("DOMContentLoaded", function () {
    const wordList = ["ergebnis","national"]; // Wortliste
    const wordLength = 8; // Nur 5-Buchstaben-Wörter
    ...
    const maxAttempts = 9; // Maximale Versuche
    ...
    function makeGuess() {
      ...
      if (guess.length !== wordLength) {
        alert("Ungültiger Versuch. Das Wort muss genau 8 Buchstaben haben.");
        return; 
      }
  
      const newWord = ["_", "_", "_", "_", "_", "_", "_", "_"];
      let correct = 0;
    ...
    function endGame(win) {
      ...
      if (win) {
        ...
        document.getElementById('next-button').style.display = 'block'; // Oder 'inline-block', je nach Bedarf
