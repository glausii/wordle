document.addEventListener("DOMContentLoaded", function () {
    const wordList = ["all","aal","eis","elf","fee","heu","tee","rad","ufo","oma","opa","ost",]; // Wortliste
    const wordLength = 3; // Nur 3-Buchstaben-Wörter
    ...
    function makeGuess() {
      ...
      if (guess.length !== wordLength) {
        alert("Ungültiger Versuch. Das Wort muss genau 3 Buchstaben haben.");
        return; 
      }
